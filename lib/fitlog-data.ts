...
const workoutImages = [
  ...
  '/images/workout-pull.png',
  '/images/workout-legs.png',
  '/images/workout-dumbbell.png',
]
...
export function normalizeWorkouts(data: unknown): Workout[] {
  ...
  const normalized = data.map((item, index) => {
    ...
    return {
      ...
      image: typeof workout.image === 'string' && workout.image.length > 0 ? workout.image : fallbackWorkouts[index % fallbackWorkouts.length].image,
