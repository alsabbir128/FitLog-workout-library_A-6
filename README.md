...
- Tailwind CSS v4
- lucide-react icons
- FitLog API with a resilient local fallback

## Features

- Responsive workout library with duration, calories, and rating sorting
- Detail pages with exercise specs and step-by-step instructions
- Today's Plan and Saved tabs with persistent browser storage
